import { MAX_WINS } from '@tongue/shared';
import type { PlayerState } from '../rooms/state/PlayerState.js';

/**
 * The ONE place Wins are added or removed.
 *
 * Stage pads and Bux grants add them; tongues and trails are BOUGHT with
 * them (`wallet.spend`, after every other check has passed). Wins are a
