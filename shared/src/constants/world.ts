...
/**
 * Spawn transform: in front of the leaderboard wall, facing the river, with
 * the training treadmills on the right and the tongue stage on the left.
 */
...
/** Y below which the player has fallen out of the world. The lava kills first. */
