import { RIVER } from '@tongue/shared';
const COURSE_END_Z = RIVER.endZ;
...
export class Sky {
  ...
  constructor() {
    ...
    this.buildClouds(0x9a1ce, Math.round((COURSE_END_Z + 900) / 48), -400, COURSE_END_Z + 500, 90 + 0, 220 + COURSE_TOP_Y, 900);
    this.buildClouds(0x51ea, Math.round((COURSE_END_Z + 1200) / 55), -600, COURSE_END_Z + 600, -90, -34, 1100);
