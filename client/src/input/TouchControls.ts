...
/**
 * Touch controls: a virtual stick, the TONGUE button and drag-to-look.
 *
...
export class TouchControls {
  ...
  constructor(look: LookSink) {
    ...
    this.jumpButton.setAttribute('aria-label', 'Throw tongue');
    this.jumpButton.innerHTML = '<span>TONGUE</span>';
  ...
  apply(state: InputState): void {
    ...
    if (this.jumpHeld || this.jumpPulse) state.tongue = true;
