...
export class MouseLook {
  ...
  /** A left click on the world while playing: the tongue. Consumed once per frame. */
  ...
  /** True once after a click that should throw the tongue. */
  ...
  private readonly onMouseDown = (event: MouseEvent): void => {
    ...
    this.cursorFree = false;
    if (this.locked) {
      // Playing: a click on the world THROWS THE TONGUE.
  ...
  private readonly onMouseUp = (): void => {
    // Where the lock is refused, a click that did not look around is a throw.
